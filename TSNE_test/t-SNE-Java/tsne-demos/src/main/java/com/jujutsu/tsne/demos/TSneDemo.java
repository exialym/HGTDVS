...
//        String type = "COIL-20";
        ...
        String savePath = type+"_withPCA_withRank_2_P20_10times_lined-avg-multip/";
        ...
        test_workflow(type,fileName,LabelName,savePath,true,true, fArr,20000,55,20.0,100, 10);
